...
pub mod exports {
    pub mod fermyon {
      ...
      ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
        ...
        unsafe extern "C" fn export_method_connection_execute(arg0: i32,arg1: *mut u8,arg2: usize,arg3: *mut u8,arg4: usize,) -> *mut u8 {
...
#[doc(inline)]
pub(crate) use __export_proxy_impl as export;

#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.21.0:proxy:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 948] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xb8\x06\x01A\x02\x01\
A\x04\x01B\x15\x04\0\x0aconnection\x03\x01\x01q\x05\x10no-such-database\0\0\x0da\
...
]connection.execute\x01\x12\x03\x01\x19fermyon:spin/sqlite@2.0.0\x05\0\x01B\x15\x04\
\0\x0aconnection\x03\x01\x01q\x05\x10no-such-database\0\0\x0daccess-denied\0\0\x12\
invalid-connection\0\0\x0ddatabase-full\0\0\x02io\x01s\0\x04\0\x05error\x03\0\x01\
\x01p}\x01q\x05\x07integer\x01x\0\x04real\x01u\0\x04text\x01s\0\x04blob\x01\x03\0\
\x04null\0\0\x04\0\x05value\x03\0\x04\x01p\x05\x01r\x01\x06values\x06\x04\0\x0ar\
ow-result\x03\0\x07\x01ps\x01p\x08\x01r\x02\x07columns\x09\x04rows\x0a\x04\0\x0c\
query-result\x03\0\x0b\x01i\0\x01j\x01\x0d\x01\x02\x01@\x01\x08databases\0\x0e\x04\
\0\x17[static]connection.open\x01\x0f\x01h\0\x01j\x01\x0c\x01\x02\x01@\x03\x04se\
lf\x10\x09statements\x0aparameters\x06\0\x11\x04\0\x1a[method]connection.execute\
\x01\x12\x04\x01\x19fermyon:spin/sqlite@2.0.0\x05\x01\x04\x01\x13fermyon:proxy/p\
roxy\x04\0\x0b\x0b\x01\0\x05proxy\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\
